...
class importNagarparishadWard implements ToModel,WithHeadingRow
{
    /**
    * @param array $row
    *
    ...
    */
    public function model(array $row)
    {
        ...
        $nagarparishadwardModel = NagarparishadWard::where('nagarparishadward_id', $nagarparishadwardModel->id)->where('name', ucfirst(trim($row['nagarparishadward'])))->first();

        if(!$nagarparishadwardModel){
            return new nagarparishadward([
                'name' => ucfirst(trim($row['nagarparishadward'])),
                'nagarparishadward_id' => $nagarparishadwardModel->id,
            ]);
        }
    }
}
