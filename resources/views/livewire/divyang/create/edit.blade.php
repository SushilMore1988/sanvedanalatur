                    ...
                    <div class="col-md-12 mx-auto">
                        <ul>
                            @foreach($errors->all() as $error)
                                <li class="invalid-feedback d-block mt-1">{{ $error }}</li>
                            @endforeach
                        </ul>
                                                        ...
                                                        <div class="col-lg-4 col-md-12 col-sm-4">
                                                            <div class="profile-img text-center bg-white image-input">
                                                                ...
                                                                <div class="upload-image image-input-inner d-flex align-items-center ">
                                                                    <img src="{{ $photo ? $photo->temporaryUrl() : url('storage/'.$photoUrl) }}" alt="your image" class="d-block"/>
                                                                </div>
                                                                @else
                                                        ...
                                                        <div class="col-lg-4 col-md-12 col-sm-4 order-lg-1 order-12 ">
                                                            <div class="signature-img text-center align-items-center bg-white image-input">
                                                                ...
                                                                <div class="upload-signature image-input-inner">
                                                                    <img src="{{ $signature ? $signature->temporaryUrl() : url($signatureUrl) }}" alt="your image" class="d-block"/>
                                                                </div>
                                                                @else
                                                ...
                                                <div class="form-row pb-2">
                                                    <div class="form-group col-md-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-4">
                                                                <div class="profile-img text-center bg-white image-input">
                                                                    @if($address_proof_doc || $address_proof_docUrl)
                                                                    <div class="upload-image image-input-inner d-flex align-items-center">
                                                                        <img src="{{ $address_proof_doc ? $address_proof_doc->temporaryUrl() : url($address_proof_docUrl) }}" alt="your image" class="d-block"/>
                                                                    </div>
                                                                    @else
                                                                    <div class="d-flex h-100 align-items-center text-center justify-content-center flex-column upload-data">
                                                                        <i class="far fa-images f-25"></i>
                                    ...
                                    <div class="col-lg-12 mx-auto basic-information">
                                        ...
                                        <div class="form-row pb-2">
                                            <div class="form-group col-md-4">
                                                    ...
                                                    <label class="switch">
                                                    {!! Form::checkbox('disability_certificate', "1", $disability_certificate ? true : false, [ "class" => "switch-input certificate", 'id' => 'certificate', 'wire:click' => '$toggle("disability_certificate")']) !!}
                                            ...
                                            <div class="form-group col-md-6" id="certificate_image_div">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 col-md-12 col-sm-4">
                                                        <div class="profile-img text-center bg-white image-input">
                                                            @if($certificate_image || $certificate_imageUrl)
                                                            <div class="upload-image image-input-inner d-flex align-items-center ">
                                                                <img src="{{ $certificate_image ? $certificate_image->temporaryUrl() : url($certificate_imageUrl) }}" alt="your image" class="d-block"/>
                                                            </div>
                                                            @else
                                                            <div class="d-flex h-100 align-items-center text-center justify-content-center flex-column upload-data">
                                                                <i class="far fa-images f-25"></i>
                                        ...
                                        <div class="form-row pb-2">
                                            <div class="form-group col-md-4">
                                                  <label class="f-14 text-dark p-regular align-self-center ">Have ST travel discount pass?</label>
                                                    <label class="switch ">
                                                    {!! Form::checkbox('st_pass', '0', $st_pass ? true : false, ['class' => 'switch-input ST_pass', 'wire:click' => '$toggle("st_pass")', 'id' => 'ST_pass']) !!}
                                                    <span class="switch-label" data-on="Yes" data-off="No"></span> 
                                                    <span class="switch-handle"></span> 
                                                </label>
                                            </div>
                                        ...
                                        <div class="form-row pb-2">
                                            <div class="form-group col-md-4">
                                                  <label class="f-14 text-dark p-regular align-self-center ">Having taken advantage of any government plan</label>
                                                    <label class="switch">
                                                    {!! Form::checkbox('government_scheme', '0', $government_scheme ? true : false, ['class' => 'switch-input goverment_scheme', 'wire:click' => '$toggle("government_scheme")', 'id' => 'goverment_scheme']) !!}
                                                    <span class="switch-label" data-on="Yes" data-off="No"></span> 
                                                    <span class="switch-handle"></span> 
                                                </label>
                                            </div>
                                        ...
                                        <div class="form-row pb-2">
                                            <div class="form-group col-md-4">
                                                  <label class="f-14 text-dark p-regular align-self-center ">Have a personal toilet?</label>
                                                    <label class="switch">
                                                    {!! Form::checkbox('personal_toilet', '0', $personal_toilet ? true : false, ['class' => 'switch-input personal_toilet', 'wire:click' => '$toggle("personal_toilet")', 'id' => 'personal_toilet']) !!}
                                                    <span class="switch-label" data-on="Yes" data-off="No"></span> 
                                                    <span class="switch-handle"></span> 
                                                </label>
                                            </div>
                                            <div class="form-group col-md-4">
                                                  <label class="f-14 text-dark p-regular align-self-center ">Do you have a home?</label>
                                                    <label class="switch">
                                                    {!! Form::checkbox('home', '0', $home ? true : false, ['class' => 'switch-input home', 'wire:click' => '$toggle("home")', 'id' => 'home']) !!}
                                                    <span class="switch-label" data-on="Yes" data-off="No"></span> 
                                                    <span class="switch-handle"></span> 
                                                </label>
                                            </div>
                                        ...
                                        <div class="form-row pb-2">
                                            <div class="form-group col-md-4">
                                                  <label class="f-14 text-dark p-regular align-self-center ">Does the need for Divyang Goods?</label>
                                                    <label class="switch">
                                                    {!! Form::checkbox('need_goods', '0', $need_goods ? true : false, ['class' => 'switch-input need_goods', 'wire:click' => '$toggle("need_goods")', 'id' => 'need_goods']) !!}
                                                    <span class="switch-label" data-on="Yes" data-off="No"></span> 
                                                    <span class="switch-handle"></span> 
                                                </label>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mx-auto basic-information">
                                            ...
                                            <div class="col-lg-8 col-md-12 col-sm-8 form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-12 col-sm-4">								
                                                        <div class="profile-img text-center bg-white image-input">
                                                            @if($identity_proof_photo || $identity_proof_photoUrl)
                                                            <div class="upload-image image-input-inner d-flex align-items-center ">
                                                                <img src="{{ $identity_proof_photo ? $identity_proof_photo->temporaryUrl() : url($identity_proof_photoUrl) }}" alt="your image" class="d-block"/>
                                                            </div>
                                                            @else
                                                            <div class="d-flex h-100 align-items-center text-center justify-content-center flex-column upload-data">
                                                                <i class="far fa-images f-25"></i>
                                        ...
                                        <div class="py-4 text-right ">
                                            ...
                                            <button type="button" class="btn btn-primary f-12 p-semibold rounded-9 px-5" wire:click="storeStep4()">Update</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
